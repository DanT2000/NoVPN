...
/** Гибкий разбор времени автосброса → часы (дробное). ЛЮБОЙ разделитель (точка,
 *  запятая, двоеточие, пробел, дефис, слэш) означает «часы‹разделитель›минуты»:
 *  «1.30» = «1 30» = «1,30» = «1:30» → час тридцать. Одно число — это часы; пусто
 *  или «0» → 0 (таймер не запускается). Минуты клампятся к 0–59. */
      ...
      {cfg.profiles === 'both' ? (
        <div className="field" style={{ marginBottom: 10 }}>
          ...
          <div className="body small muted" style={{ marginTop: 6 }}>
            ...
            <br />
            Любой разделитель = часы·минуты: <b>1:30</b>, <b>1 30</b>, <b>1.30</b>, <b>1,30</b> —
            всё это час тридцать; <b>2</b> — два часа. Показываем как <b>ч:мм</b>.
            <br />
