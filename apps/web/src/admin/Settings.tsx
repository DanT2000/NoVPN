  ...
  return (
    <>
      ...
      <div className="stack" style={{ gap: 16, maxWidth: 640 }}>
        ...
        {/* Продвинутый режим X-Ray: список исключений + аварийный фоллбэк */}
        <Panel title="Продвинутый режим X-Ray">
          <div className="body small muted" style={{ marginBottom: 10 }}>
            Подписка X-Ray отдаётся как полный конфиг, где <b>российские домены идут
            напрямую</b>, мимо VPN, и с <b>аварийным фоллбэком</b>: если
